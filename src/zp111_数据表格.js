...
function init(_ref) {
    ...
    if (props.diyColumn && props.columns) {
        ...
        if (P.diyColumn && ref.isDev) ref.updateMeta("p.P.columns", Head.map(k => { return { header: k, path: k } }))
    }

    const oData = JSON.parse(JSON.stringify(data))
    load(U => {
        Head.forEach((v, i) => data[0][i] = { v, s: { ht: 2, bl: 1 } })
        let workbook = U.createUniverSheet({ sheets: { "sheet-01": { name: "Sheet01", cellData: data, columnData, rowCount: list.length + 9, columnCount: Head.length + 3 } } })
...
function load(cb) {
    const arr = [
        "https://unpkg.com/@univerjs/design@0.1.0-beta.2/lib/index.css",
        "https://unpkg.com/@univerjs/ui@0.1.0-beta.2/lib/index.css",
        "https://unpkg.com/@univerjs/sheets-ui@0.1.0-beta.2/lib/index.css",
        "https://unpkg.com/@univerjs/sheets-formula@0.1.0-beta.2/lib/index.css",
        "https://unpkg.com/@univerjs/sheets-numfmt@0.1.0-beta.2/lib/index.css",
        ...
        "https://unpkg.com/@univerjs/core@0.1.0-beta.2/lib/umd/index.js",
        "https://unpkg.com/@univerjs/design@0.1.0-beta.2/lib/umd/index.js",
        "https://unpkg.com/@univerjs/engine-render@0.1.0-beta.2/lib/umd/index.js",
        "https://unpkg.com/@univerjs/engine-formula@0.1.0-beta.2/lib/umd/index.js",
        "https://unpkg.com/@univerjs/ui@0.1.0-beta.2/lib/umd/index.js",
        "https://unpkg.com/@univerjs/sheets@0.1.0-beta.2/lib/umd/index.js",
        "https://unpkg.com/@univerjs/docs@0.1.0-beta.2/lib/umd/index.js",
        "https://unpkg.com/@univerjs/sheets-ui@0.1.0-beta.2/lib/umd/index.js",
        "https://unpkg.com/@univerjs/sheets-formula@0.1.0-beta.2/lib/umd/index.js",
        "https://unpkg.com/@univerjs/sheets-numfmt@0.1.0-beta.2/lib/umd/index.js",
        "https://unpkg.com/@univerjs/facade@0.1.0-beta.2/lib/umd/index.js",
    ]
    exc('load(arr)', { arr }, () => {
